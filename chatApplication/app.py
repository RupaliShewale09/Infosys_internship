...
class ChatApp:
    ...
    # shows login and create an account screen
    ...
    # ---------------- Signup ----------------
    # create account screen - username, phone, pass
    ...
    # reloads and displays latest messages
    ...
    # Saves and sends a message to the selected user
    def send(self):
        if not self.current_chat_user:
    ...
    def auto_refresh_users(self):
        self.load_user_list()
        self.root.after(1000, self.auto_refresh_users)  

    # ---------------- Refresh chat area ----------------
    # Automatically refreshes chat at regular interval 
